...
var Layout = function Layout(props) {
  return _react2.default.createElement('div', null, _react2.default.createElement('link', { rel: 'icon',
    type: 'image/x-icon',
    src: '/static/favicon.ico' }), _react2.default.createElement('meta', { content: 'width=device-width, initial-scale=1', name: 'viewport' }), _react2.default.createElement('link', { rel: 'shortcut icon', src: '/static/favicon.io', type: 'image/x-icon' }), _react2.default.createElement('link', { rel: 'icon', src: '/static/favicon.io', type: 'image/x-icon' }), _react2.default.createElement(_Header2.default, null), _react2.default.createElement('div', { style: layoutStyle, 'data-jsx': 1381055048
