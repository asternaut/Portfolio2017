  ...
  <link href="https://fonts.googleapis.com/css?family=Droid+Sans+Mono|Montserrat:400,700" rel="stylesheet" />
    ...
    <wrapper className="projectWrapper">
      ...
      <a href="#_" className="lightBox" id="img4">
        <img src={'/static/Artboard 1 copy.png'} alt="" />
        <figcaption> FREIGHT MONSTER: Here is a glimpse into a site I designed. It is currently in the works, so these are some of my mock-ups. They were done in Illustrator. I designed 100% of this, even the icons! This shows some UX/UI, depicting the navigation on desktop and mobile. </figcaption>
      </a>
